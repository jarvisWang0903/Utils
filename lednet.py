...
from color2label import _ConvBNReLU
...
def get_lednet(dataset='citys', backbone='', pretrained=False, root='~/.torch/models',
    ...
    model = LEDNet(20, backbone=backbone, pretrained_base=pretrained_base, **kwargs)
    return model
...
if __name__ == '__main__':
    ...
    summary(model, input_size=(3, 512, 1024), batch_size=1, device='cpu' )